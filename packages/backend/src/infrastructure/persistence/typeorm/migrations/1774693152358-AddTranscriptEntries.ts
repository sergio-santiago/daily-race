...
export class AddTranscriptEntries1774693152358 implements MigrationInterface {
    name = 'AddTranscriptEntries1774693152358'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "transcript_entries" DROP CONSTRAINT "FK_c42b714bf6ca201fa018b65c708"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c42b714bf6ca201fa018b65c70"`);
        await queryRunner.query(`DROP TABLE "transcript_entries"`);
    }
